...
// th, td {  <- update to styles using medium to center schedule, import events through backend, if this doesn't work maybe counter classes???
//     text-align: left;
//     padding: 8px;
...
const SchManager = () => {
    ...
    const config = {
        ...
        onTimeRangeSelected: async args => {
          ...
          if (!calendar) return;
          //const modal = await DayPilot.Modal.form(oForm, oData);
