  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
        <div className="max-w-5xl bg-white rounded-2xl shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-4 text-center">About Our Eye Clinic</h1>
          ...
          <div className="flex flex-col md:flex-row items-start justify-between">
            ...
            <div className="w-full md:w-1/2 pr-6">
              <h2 className="text-2xl font-semibold text-gray-700 mb-3">Clinic Locations</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mt-6 mb-3">Meet Our Specialists</h2>
